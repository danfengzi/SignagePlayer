...
//import com.scoindia.infomax.application.player.config.ConnectToServer;
 ...
 * @version 3.4
 */
public class InfoMaxSchedulerPlayer  implements Observer{
	...
	Date playTime_FullScreenADVT;
	String playAt, play_at, playItemPath;
	static int hh, mm, ss, repeat_for, play_every;
	...
	String rss_msg = "";
	static RSSFeedParser rssParser;
	...
	public InfoMaxSchedulerPlayer(List<PlayItem> play_List) {
		...
		mainFrame = new Frame();
		// mainFrame.setIconImage(new ImageIcon(getClass()
		//							.getResource("/icons/vlcj-logo.png")).getImage());
	...
	/**
	 * creates the ADVT Layout and RSS Layout
	 */
